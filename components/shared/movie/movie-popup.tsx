...
const MoviePopup = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto !scrollbar-thin !scrollbar-track-transparent !scrollbar-thumb-red-600">
      {isLoading ? (
          <>
          ...
          <>
            ...
            <div className="flex flex-col space-y-4">
              <h1 className="text-2xl md:text-4xl font-bold line-clamp-1">
              ...
              <div className="flex flex-row items-center flex-wrap gap-2">
                ...
                <div className="inline-flex text-green-400 font-semibold border-2 border-white/40 rounded px-2">HD</div>
              </div>
            </div>
            ...
            <div className={"bg-black p-4 rounded-md shadow-2xl"}>
              ...
              <div className="grid grid-cols-3 gap-3 items-center scrollbar-hide md:p-2">
                {similarMovies && similarMovies.length && similarMovies.filter(item => item.backdrop_path !== null && item.poster_path !== null).map(movie => (
